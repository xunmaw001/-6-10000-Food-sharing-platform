      ...
      <el-form :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
        <el-row :style='{"display":"block"}'>
			<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
			  <label :style='{"margin":"0 10px 0 0","color":"#000","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">趣味答题</label>
			  <el-input v-model="searchForm.papername" placeholder="趣味答题名称" clearable></el-input>
			</div>
			<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
			...
			<el-button :style='{"border":"1px solid #FF8C51 ","cursor":"pointer","padding":"0 24px","outline":"none","color":"#FF8C51","borderRadius":"0","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' round @click="search()">查询</el-button>
		</el-row>
        <el-row :style='{"margin":"20px 0","display":"flex"}'>
          <el-button :style='{"border":"2px solid #FF8C51","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#FF8C51","borderRadius":"0","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}' type="primary" @click="addOrUpdateHandler()" round>新增</el-button>
          <el-button
		     :style='{"border":"2px solid #FF8C51","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#FF8C51","borderRadius":"0","background":"#fff","width":"auto","fontSize":"14px","height":"40px"}'
