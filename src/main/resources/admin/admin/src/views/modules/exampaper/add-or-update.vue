<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="趣味答题名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="趣味答题名称" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="趣味答题名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="趣味答题名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="趣味答题状态" prop="status">
					<el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="请选择趣味答题状态" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="趣味答题状态" prop="status">
					<el-input v-model="ruleForm.status?'启用':'禁用'" 
						placeholder="趣味答题状态" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				name: [
					{ required: true, message: '趣味答题名称不能为空', trigger: 'blur' },
				],
				time: [
				...
				status: [
					{ required: true, message: '趣味答题状态不能为空', trigger: 'blur' },
					{ validator: validateIntNumber, trigger: 'blur' },
				],
			}
		};
