<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="菜谱名称" prop="caipumingcheng">
					<el-input v-model="ruleForm.caipumingcheng" placeholder="菜谱名称" clearable  :readonly="ro.caipumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="菜谱名称" prop="caipumingcheng">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.caipufengmian" label="菜谱封面" prop="caipufengmian">
					<file-upload
						tip="点击上传菜谱封面"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.caipufengmian" label="菜谱封面" prop="caipufengmian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="口味" prop="kouwei">
					<el-input v-model="ruleForm.kouwei" placeholder="口味" clearable  :readonly="ro.kouwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="口味" prop="kouwei">
					<el-input v-model="ruleForm.kouwei" placeholder="口味" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="材料" prop="cailiao">
					<el-input v-model="ruleForm.cailiao" placeholder="材料" clearable  :readonly="ro.cailiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="材料" prop="cailiao">
					<el-input v-model="ruleForm.cailiao" placeholder="材料" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="制作工艺" prop="zhizuogongyi">
					<el-input v-model="ruleForm.zhizuogongyi" placeholder="制作工艺" clearable  :readonly="ro.zhizuogongyi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="制作工艺" prop="zhizuogongyi">
					<el-input v-model="ruleForm.zhizuogongyi" placeholder="制作工艺" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="适应人群" prop="shiyingrenqun">
					<el-input v-model="ruleForm.shiyingrenqun" placeholder="适应人群" clearable  :readonly="ro.shiyingrenqun"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="适应人群" prop="shiyingrenqun">
					<el-input v-model="ruleForm.shiyingrenqun" placeholder="适应人群" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="功效营养" prop="gongxiaoyingyang">
					<el-input v-model="ruleForm.gongxiaoyingyang" placeholder="功效营养" clearable  :readonly="ro.gongxiaoyingyang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="功效营养" prop="gongxiaoyingyang">
					<el-input v-model="ruleForm.gongxiaoyingyang" placeholder="功效营养" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="菜谱详情" prop="caipuxiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.caipuxiangqing" label="菜谱详情" prop="caipuxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.caipuxiangqing"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.caipuxiangqing = this.ruleForm.caipuxiangqing.replace(reg,'../../../springbootc71oi/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
