		...
		<div :style='{"width":"100%","padding":"10px","margin":"12px 0 0px 0","borderRadius":"8px","background":"#fff","height":"auto"}' class="swiper-container" id="recommendcaipuxinxi">
			<div class="swiper-wrapper">
				<div class="swiper-slide animation-box" :style='{"border":"0","cursor":"pointer","padding":"0 0 8px 0","borderRadius":"8px","background":"rgba(242, 242, 242,.6)","fontSize":"0","position":"relative"}' v-for="(item,index) in caipuxinxiRecommend" :key="index" @click="toDetail('caipuxinxiDetail', item)">
					<img :name="item.id" :style='{"border":"0","width":"100%","borderRadius":"8px 8px 0 0","height":"220px"}' v-if="item.caipufengmian.substr(0,4)=='http'" :src="item.caipufengmian.split(',')[0]" alt="" />
					...
					<div class="line1" :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#333","background":"#f8f8fc"}'>菜谱名称:{{item.caipumingcheng}}</div>
					<div class="line1" :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#333","background":"#f8f8fc"}'>{{item.caipinfenlei}}</div>
					<div class="line1" :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#333","background":"#f8f8fc"}'>{{item.kouwei}}</div>
				</div>
			</div>
			<!-- 如果需要导航按钮 -->
